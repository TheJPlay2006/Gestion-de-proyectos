...
public class FormularioUsuario extends JDialog {
    ...
    private void guardarUsuario() {
        try {
            ...
            // Validación básica de correo (opcional pero buena práctica)
            ...
            usuario.setCorreoElectronico(correo.isEmpty() ? null : correo); // Manejar null
            ...
            if (exito) {
                ...
                JOptionPane.showMessageDialog(this, "Error al guardar el usuario. Puede que el nombre de usuario ya exista.", "Error", JOptionPane.ERROR_MESSAGE);
            }
