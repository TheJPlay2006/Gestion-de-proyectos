...
public class TablaUsuarios extends JPanel {
    ...
    private void eliminarUsuarioSeleccionado() {
        ...
        if (filaSeleccionada >= 0) {
            try {
                int id = (int) modeloTabla.getValueAt(filaSeleccionada, 0);
                String nombre = (String) modeloTabla.getValueAt(filaSeleccionada, 2); // Nombre completo
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    if (usuarioServicio.eliminarUsuario(id)) {
                        ...
                        JOptionPane.showMessageDialog(this, "Error al eliminar el usuario. Puede estar asociado a tareas.", "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
            } catch (Exception e) {
