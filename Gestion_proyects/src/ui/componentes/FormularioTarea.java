...
public class FormularioTarea extends JDialog {
    ...
    private JComboBox<Usuario> cmbAsignadoA;
    ...
    public FormularioTarea(Window parent, Tarea tarea) {
        super(parent, tarea == null ? "Nueva Tarea" : "Editar Tarea", 
    ...
    private void cargarUsuarios() {
        ...
        cmbAsignadoA.addItem(null); // Opción vacía
        
        List<Usuario> usuarios = usuarioServicio.obtenerTodosLosUsuarios();
        for (Usuario usuario : usuarios) {
            cmbAsignadoA.addItem(usuario);
        }
    }
    ...
    private void guardarTarea() {
        try {
            ...
            if (titulo.isEmpty()) {
                JOptionPane.showMessageDialog(this, "El título de la tarea es obligatorio", 
            ...
            if (proyectoIdStr.isEmpty()) {
                JOptionPane.showMessageDialog(this, "El ID del proyecto es obligatorio", 
                                            "Error", JOptionPane.ERROR_MESSAGE);
            ...
            try {
                ...
                if (proyectoId <= 0) {
                    JOptionPane.showMessageDialog(this, "El ID del proyecto debe ser un número positivo", 
                                                "Error", JOptionPane.ERROR_MESSAGE);
                    txtProyectoId.requestFocus();
                    return;
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(this, "El ID del proyecto debe ser un número válido", 
                                            "Error", JOptionPane.ERROR_MESSAGE);
                txtProyectoId.requestFocus();
                return;
            }
            ...
            if (!txtFechaVencimiento.getText().trim().isEmpty()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(this, "Formato de fecha de vencimiento inválido. Use dd/MM/yyyy", 
                                                "Error", JOptionPane.ERROR_MESSAGE);
            ...
            // Validar que fecha inicio no sea posterior a fecha vencimiento
